  ...
  return (
    <div className="relative w-full animate-slide-up">
        ...
        <LoginModal 
            ...
            description={t.loginToFavorite || 'Please login to manage favorites'}
            t={t}
        />
            ...
            <div className="flex items-center justify-between mb-1 gap-2">
                <div className="flex-1 flex items-center gap-2 min-w-0">
                    <button 
                        ...
                        className="p-1 rounded-full hover:bg-surface-button-hover active:scale-95 transition-all focus:outline-none flex-shrink-0"
                    ...
                    <h2 className="text-xl font-semibold text-text-primary truncate" id="placeName">
                        {displayName}
                    </h2>
                </div>
                ...
                <button 
                    ...
                    className="p-1.5 rounded-full hover:bg-surface-button-hover active:scale-95 transition-all text-text-secondary hover:text-text-primary"
                    title="Share Link"
                >
